...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <nav class="bg-blue-500 p-4 flex justify-between items-center text-white">
        ...
        <div class="space-x-4">
            <a href="{{ route('landing') }}" class="bg-white text-blue-500 px-4 py-2 rounded hover:bg-blue-600">Kembali</a>
        </div>
    </nav>

    <!-- Landing Page -->
    <div class="min-h-screen bg-gray-50 flex items-center justify-center">
        <form action="{{ route('login') }}" method="POST" class="bg-white p-6 rounded shadow-md space-y-4">
            @csrf
