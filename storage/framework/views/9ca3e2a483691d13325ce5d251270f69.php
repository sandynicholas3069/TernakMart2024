...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center">
        <form action="<?php echo e(route('register')); ?>" method="POST" class="bg-gray-800 p-6 rounded shadow-md space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-blue-300 text-sm hover:underline transition-colors duration-300">Login</a>
        </form>
    </div>
...
</html><?php /**PATH D:\Apps\laragon\www\ternakmart\resources\views/register.blade.php ENDPATH**/ ?>