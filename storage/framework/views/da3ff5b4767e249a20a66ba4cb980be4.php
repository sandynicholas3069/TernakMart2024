...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <nav class="bg-blue-500 p-4 flex justify-between items-center text-white">
        ...
        <div class="space-x-4">
            <a href="<?php echo e(route('login')); ?>" class="bg-white text-blue-500 px-4 py-2 rounded hover:underline transition-colors duration-300">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="bg-white text-blue-500 px-4 py-2 rounded hover:underline transition-colors duration-300">Register</a>
        </div>
    </nav>
...
</html><?php /**PATH D:\Apps\laragon\www\ternakmart\resources\views/landing.blade.php ENDPATH**/ ?>